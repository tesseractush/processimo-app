    ...
    return (
      <div className="container py-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-6">The agent workforce you're looking for might have been removed or doesn't exist.</p>
          <Button asChild>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <motion.div 
                      ...
                      style={{ 
                        width: `calc(50vw - ${index % 2 === 0 ? "right" : "left"}-12px - 6rem)`,
                        maxWidth: "10rem"
                      }}
                      initial={{ width: 0 }}
